...
import { submitNewSong, type ContributeActionState } from './actions';
...
export function ContributeForm() {
  const [state, formAction, isPending] = useActionState(submitNewSong, initialState);
  ...
  if (state.ok) {
    return (
      <div className="flex flex-col items-center gap-4 py-12 text-center">
        ...
        <h2 className="text-xl font-semibold">Song submitted!</h2>
        <p className="text-muted-foreground max-w-sm">
          Your song has been sent for review. An editor will approve it before it appears publicly.
        </p>
        <Link href="/songs">
      ...
      <form action={formAction} className="space-y-5">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="space-y-1.5">
            ...
            <Select
              name="original_key"
              onValueChange={(v) => { setPreviewKey(String(v ?? '')); }}
            >
          ...
          <div className="space-y-1.5">
            ...
            <Input id="bpm" name="bpm" type="number" min={20} max={300} placeholder="72" />
          </div>
          <div className="space-y-1.5">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="space-y-1.5">
            ...
            <Input id="artist_original" name="artist_original" placeholder="Traditional" />
          </div>
          <div className="space-y-1.5">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="space-y-1.5">
            ...
            <Input id="themes" name="themes" placeholder="praise, christmas, communion" />
          </div>
          <div className="space-y-1.5">
            ...
            <Input id="language" name="language" placeholder="hi, en" defaultValue="hi" />
          </div>
        </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <div className="space-y-1.5">
            ...
            <Input id="source_name" name="source_name" placeholder="e.g. Masihi Geet Mala" />
          </div>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <textarea
            id="notes"
            name="notes"
            placeholder="Describe the song's origin, any copyright info you know, etc."
